...
import 'package:project123/user/login/widgets/custom_clippers/brown_top_clipper.dart';
import 'package:project123/user/login/widgets/custom_clippers/gold_top_clipper.dart';
import 'package:project123/user/login/widgets/custom_clippers/lightgold_top_clipper.dart';
...
class LoginPage extends State<Login> {
  ...
  late SharedPreferences logindata_mobile;
  var sessionData;
  ...
  {
    final responce = await http.get(Uri.parse("https://amisha1299.000webhostapp.com/Ewishes/Register/register_session_view.php?data="+mobileno.text.toString()));
