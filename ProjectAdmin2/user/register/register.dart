...
class RegisterPage extends State<Register> {
 ...
 // }
  ...
  void insertData(){
    var url1 = "https://topsapi.000webhostapp.com/flutter_project_morning/Register/register_insert.php";
  ...
  Future viewMobileNoData() async {
    var url = "https://topsapi.000webhostapp.com/flutter_project_morning/Register/register_unique_mobileno_view.php";
